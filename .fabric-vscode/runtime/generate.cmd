...
docker run --network fabricvscodelocalfabric_basic --rm -v %CD%:/etc/hyperledger/fabric hyperledger/fabric-ca:1.4.1 fabric-ca-client enroll -u http://admin:adminpw@ca.org1.example.com:17054 -M /etc/hyperledger/fabric/admin-msp
